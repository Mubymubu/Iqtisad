          ...
          <div className="space-y-6">
            ...
            <Card className="bg-card/50">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed mt-2">
                  To earn 2 stars, the player must finish the level with a <strong className="text-foreground">net worth increase of at least 10%</strong> and complete at least <strong className="text-foreground">5 trades</strong>.
                </p>
                <p className="text-sm text-muted-foreground/80 italic mt-2">
